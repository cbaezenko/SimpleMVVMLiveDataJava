package com.singorenko.simplemvvmandroidjava.repositories;
...
public class NicePlaceRepository {
    ...
    //Emulate a Singleton for a possible connection with the server side.
    ...
    //Here make queries or access the cache
    ...
    //This mimic the retrieving data from a database
